function fig = LG_6DoFAnimiation_Double( varargin )
...
Spin = 120;
% View = [(-90:(Spin/(length(pP_total)-1)):(-90+Spin))', 0*ones(length(pP_total), 1)];
View = [(48:(Spin/(length(pP_total)-1)):(48+Spin))', 20*ones(length(pP_total), 1)];
...
%     trajHandle = plot3(traj.des_x,traj.des_y,traj.des_z,'r-.');
%     line1XLhandle = line('XData',[2-0.45,2-0.45],'YData',[3-0.0,3-0.0],'ZData',0.8+[-0.2,1.3],'LineWidth',4,'Color',[128 42 42]/256.0);
    %line1XRhandle = line('XData',[2+0.45,2+0.45],'YData',[3+0.0,3+0.0],'ZData',0.8+[-0.2,1.3],'LineWidth',4,'Color',[128 42 42]/256.0);
    
%     line1ZDhandle = line('XData',[2-0.45,2+0.45],'YData',[3-0.0,3+0.0],'ZData',0.8+[-0.2,-0.2],'LineWidth',4,'Color',[128 42 42]/256.0);
...
%     line1ZUhandle = line('XData',[2-0.45,2+0.45],'YData',[3-0.0,3+0.0],'ZData',0.8+[1.3,1.3],'LineWidth',4,'Color',[128 42 42]/256.0);
...
%%
    for i = 1:numPlotSamples
        ...
        ratio = 0.4;
        set(org1Handle, 'xdata', xQ1, 'ydata', yQ1, 'zdata', zQ1,'Color','b','MarkerSize',5);% Q1 mass center
        ...
        set(org2Handle, 'xdata', xQ2, 'ydata', yQ2, 'zdata', zQ2,'Color','c','MarkerSize',5);% Q2 mass center
