...
%% 更新机体坐标系
ratio = 0.4;
set(phandles.quivXhandle_Q1, 'xdata', xQ1, 'ydata', yQ1, 'zdata', zQ1,...
    'udata', ratio*ux1, 'vdata', ratio*vx1, 'wdata', ratio*wx1);
set(phandles.quivYhandle_Q1, 'xdata', xQ1, 'ydata', yQ1, 'zdata', zQ1,...
    'udata', ratio*uy1, 'vdata', ratio*vy1, 'wdata', ratio*wy1);
set(phandles.quivZhandle_Q1, 'xdata', xQ1, 'ydata', yQ1, 'zdata', zQ1,...
    'udata', ratio*uz1, 'vdata', ratio*vz1, 'wdata', ratio*wz1);

set(phandles.quivXhandle_Q2, 'xdata', xQ2, 'ydata', yQ2, 'zdata', zQ2,...
    'udata', ratio*ux2, 'vdata', ratio*vx2, 'wdata', ratio*wx2);
set(phandles.quivYhandle_Q2, 'xdata', xQ2, 'ydata', yQ2, 'zdata', zQ2,...
    'udata', ratio*uy2, 'vdata', ratio*vy2, 'wdata', ratio*wy2);
set(phandles.quivZhandle_Q2, 'xdata', xQ2, 'ydata', yQ2, 'zdata', zQ2,...
...
set(phandles.lineQ1Xhandle,'XData',Q1X1,'YData',Q1X2,'ZData',Q1X3);
set(phandles.lineQ1Yhandle,'XData',Q1Y1,'YData',Q1Y2,'ZData',Q1Y3);
set(phandles.Q1circle1handle,'XData',x1r1(:,1),'YData',x1r1(:,2),'ZData',x1r1(:,3));
set(phandles.Q1circle2handle,'XData',x1r2(:,1),'YData',x1r2(:,2),'ZData',x1r2(:,3));
set(phandles.Q1circle3handle,'XData',x1r3(:,1),'YData',x1r3(:,2),'ZData',x1r3(:,3));
set(phandles.Q1circle4handle,'XData',x1r4(:,1),'YData',x1r4(:,2),'ZData',x1r4(:,3));
%% 更新第二架四旋翼
    len = 0.34; % distance from the center of rotor 1 to rotor 3; 
...
%% 更新cable
set(phandles.cable1handle, 'XData',[xQ1,xP],'YData',[yQ1,yP],'ZData',[zQ1,zP]);
set(phandles.cable2handle, 'XData',[xQ2,xP],'YData',[yQ2,yP],'ZData',[zQ2,zP]);
%% 设置坐标范围
LimitRatio = 1;AxisLength = 1;
AxisLengthX = 2;AxisLengthY = 1.5;AxisLengthZ = 1;
axisLimChanged = 1;
if((xQ1 - AxisLengthX) < phandles.Xlim(1)), phandles.Xlim(1) = xQ1 - LimitRatio*AxisLengthX; axisLimChanged = true; end
if((yQ1 - AxisLengthY) < phandles.Ylim(1)), phandles.Ylim(1) = yQ1 - LimitRatio*AxisLengthY; axisLimChanged = true; end
if((zQ1 - AxisLengthZ) < phandles.Zlim(1)), phandles.Zlim(1) = zQ1 - LimitRatio*AxisLengthZ; axisLimChanged = true; end
if((xQ1 + AxisLengthX) > phandles.Xlim(2)), phandles.Xlim(2) = xQ1 + LimitRatio*AxisLengthX; axisLimChanged = true; end
if((yQ1 + AxisLengthY) > phandles.Ylim(2)), phandles.Ylim(2) = yQ1 + LimitRatio*AxisLengthY; axisLimChanged = true; end
if((zQ1 + AxisLengthZ) > phandles.Zlim(2)), phandles.Zlim(2) = zQ1 + LimitRatio*AxisLengthZ; axisLimChanged = true; end
